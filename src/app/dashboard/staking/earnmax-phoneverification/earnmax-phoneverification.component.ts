...
@Component({
  selector: 'app-earnmax-phoneverification',
  templateUrl: './earnmax-phoneverification.component.html',
  styleUrls: ['./earnmax-phoneverification.component.css']
})
export class EarnmaxPhoneverificationComponent implements OnInit {
  url:any
errormessage: any;
otp:any
addOtp!:FormGroup
